...
# ID de la subred privada creada para recursos internos del proyecto final.
output "private_subnet_id" {
  description = "ID de la subred privada creada para recursos internos."
  value       = oci_core_subnet.lab4_private_subnet.id
}

# CIDR de la subred privada.
output "private_subnet_cidr" {
  description = "Rango CIDR de la subred privada."
  value       = oci_core_subnet.lab4_private_subnet.cidr_block
}
...
# Nombre visible de la VM privada de base de datos.
output "db_vm_name" {
  description = "Nombre visible de la VM privada de base de datos."
  value       = oci_core_instance.proyecto_final_db_vm.display_name
}

# OCID de la VM privada de base de datos.
output "db_vm_ocid" {
  description = "OCID de la VM privada de base de datos."
  value       = oci_core_instance.proyecto_final_db_vm.id
}

# Direccion IP privada de la VM de base de datos.
output "db_vm_private_ip" {
  description = "Direccion IP privada asignada a la VM de base de datos."
  value       = oci_core_instance.proyecto_final_db_vm.private_ip
}
